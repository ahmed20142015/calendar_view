...
import '_custom_internal_week_view_page.dart';

/// [Widget] to display week view.
class CustomDayView<T extends Object?> extends StatefulWidget {
  ...
  @override
  CustomDayViewState<T> createState() => CustomDayViewState<T>();
}

class CustomDayViewState<T extends Object?> extends State<CustomDayView<T>> {
  late double _width;
  late double _height;
  ...
  @override
  void didUpdateWidget(CustomDayView<T> oldWidget) {
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      return ValueListenableBuilder(
                          ...
                          builder: (_, __, ___) => CustomInternalWeekViewPage<T>(
                            ...
                            selectedDateTime: DateTime(DateTime.now().year,DateTime.now().month,DateTime.now().day),
                          ));
                    },
                  ),
                ),
